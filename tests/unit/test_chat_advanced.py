...
async def test_process_query_with_max_retries():
    ...
    # Mock the methods
    with (
        patch.object(handler, "_get_trading_thesis_prompt") as mock_get_prompt,
...
async def test_process_query_trading_thesis():
    ...
    # Mock response data
    mock_result = {"result": "This is a trading thesis", "source_documents": []}
...
async def test_process_query_default_to_general():
    ...
    # Mock response data
    mock_result = {"result": "General response", "source_documents": []}

    # Mock the methods
    with (
        patch.object(handler, "_get_general_prompt") as mock_get_prompt,
        patch.object(handler, "_create_qa_chain") as mock_create_chain,
